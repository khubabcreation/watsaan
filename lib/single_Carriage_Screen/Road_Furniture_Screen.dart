          ...
          child: Column(
            children: [
              ...
              FittedBox(child: Row(children: [
               ...
               MyDropdownButton(height: height*0.04, widht: width*0.25, hint_txt:'', dropdownOptions: ['Yes','No','Few'],ontap: (signalva){
                 signalval = signalva!;
               }),
