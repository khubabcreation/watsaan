...
class FurnitureSuperAdmin extends StatefulWidget {
  const FurnitureSuperAdmin({Key? key}) : super(key: key);

  @override
  State<FurnitureSuperAdmin> createState() => _FurnitureSuperAdminState();
}

class _FurnitureSuperAdminState extends State<FurnitureSuperAdmin> {
  final snap = FirebaseFirestore.instance.collection('road_furniture').snapshots();
  @override
...
/// i want to display this data in the form of excel in flutter
///